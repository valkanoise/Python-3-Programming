enunciado = '''Define a class called BankAccount that accepts the name you want 
...
[name goes here], has [start_amt goes here] dollars." Create an instance of 
this class with "Bob" as the name and 100 as the amount. Save this to the 
variable t1.'''

class BankAccount():
    def __init__(self,string_name, int_money):
